...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.fn = fn = '/media/rytse/Seagate Backup Plus Drive/Flash Drive/cubesat/new sh recordings/will not copy/IQREC-02-03-19-12h31m01s566.iq'
        self.f0 = f0 = 6043612
        ...
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/rytse/Documents/cubesat/gr-chirphunter/data/out/real_nofilt_nodecim_adj.out', False)
        ...
        self.connect((self.iqsource_1, 0), (self.blocks_multiply_xx_1, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 8e6, 0.1e6, firdes.WIN_HAMMING, 6.76))
